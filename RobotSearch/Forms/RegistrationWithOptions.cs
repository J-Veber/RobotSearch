...
{
    public partial class RegistrationWithOptions : Form
    {
        public Form MyForm;
        ...
        public RegistrationWithOptions(Form inputForm)
        {
            InitializeComponent();
            MyForm = inputForm;
        ...
        private void button_regAdm_Click(object sender, EventArgs e)
        {
        ...
        private void RegistrationWithOptions_Load(object sender, EventArgs e)
        {
